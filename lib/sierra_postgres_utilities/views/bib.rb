    ...
    module Bib
      ...
      views = [
        ...
        },
        {
          ...
          view_match: :bib_record_id, obj_match: :record_id, require: :record_id,
          openstruct: true, entries: :first
        },
        {
        ...
        },
        {
          ...
          view_match: :bib_record_id, obj_match: :record_id, require: :record_id,
          openstruct: true, entries: :all, sort: :orders_display_order
        },
        {
        ...
        },
        {
          ...
          view_match: :bib_record_id, obj_match: :record_id, require: :record_id,
          openstruct: true, entries: :all, sort: :volumes_display_order
        },
        {
          view: :bib_view,
          view_match: :id, obj_match: :record_id, require: :record_id,
        ...
        },
        {
          ...
          sort: [:varfield_type_code, :occ_num, :id]
        },
        {
          view: :leader_field,
          view_match: :record_id, obj_match: :record_id, require: :record_id,
          ...
          # possible.
          openstruct: true, entries: :first,
          require_fail_return: OpenStruct.new, if_empty: OpenStruct.new
        },
      ]
